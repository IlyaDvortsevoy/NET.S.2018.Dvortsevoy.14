...
namespace SearchAlgorithm.Tests
{
    ...
    public class SearchAlgorithmTests
    {
        ...
        {
            Assert.That(() => Search<int>.BinarySearch(null, 12),
        ...
        {
            Assert.That(() => Search<Person>.BinarySearch(TestCustom, null),
               Throws.InstanceOf<ArgumentNullException>());
        }
        ...
        {
            Assert.That(Search<int>.BinarySearch(TestInt, 33),
                Is.EqualTo(4));
        }
        ...
        {
            Assert.That(Search<double>.BinarySearch(TestDouble, -13.6),
                Is.EqualTo(1));
        }
        ...
        {
            Assert.That(Search<Person>.BinarySearch(TestCustom, new Person("Alex", 24)),
                Is.EqualTo(1));
        }
    }
}